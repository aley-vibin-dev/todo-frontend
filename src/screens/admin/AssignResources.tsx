...
export const AssignResources = () => {
  ...
  const ListHeader = () => (
    <View className="mb-4">
      <Text className="text-2xl font-bold mb-4">Assign Resources</Text>
            ...
            {(['assign', 'unassign'] as const).map((mode) => (
              <TouchableOpacity
                ...
                className={`flex-1 p-3 rounded-lg border ${
                  actionMode === mode ? mode === 'assign' ? 'bg-indigo-600 border-indigo-600' : 'bg-red-600 border-red-600' : 'bg-white border-gray-300'
                }`}
              >
